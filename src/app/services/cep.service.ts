...
import { CepDTO } from '../entities/cep.dto';
...
export class CepService {
  ...
  getAddressByCep(cep: string):Observable<CepDTO>{
   return this.http.get<CepDTO>('http://viacep.com.br/ws/'+cep+'/json/');
  }


  getJsonStateAndCitty(): StateDTO[]{
    var json: StateDTO[] = [
        {
          "sigla": "AC",
          "nome": "Acre",
